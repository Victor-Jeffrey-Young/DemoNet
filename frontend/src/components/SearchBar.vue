...
<template>
  <div class="relative">
    <input v-model="query" @input="doSearch" @keydown.enter="doSearch"
    ...
    <button v-if="query" @click="clear" class="absolute right-3 top-2.5 text-gray-500 hover:text-white">✕</button>
  </div>
</template>
