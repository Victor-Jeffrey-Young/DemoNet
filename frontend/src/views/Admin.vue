          ...
          <div v-loading="settingsLoading" class="max-w-2xl">
            ...
            <div v-for="(val, key) in settings" :key="key" class="flex items-center gap-3 mb-3" v-show="key !== 'INVITE_ONLY'">
              ...
              <el-input
                ...
                class="flex-1"
              />
              <el-button size="small" type="primary" @click="saveSetting(key)">保存</el-button>
            </div>
            ...
            <div class="flex items-center gap-3 mb-3">
              ...
              <el-button size="small" type="primary" @click="handleGenerateInviteCodes">生成 5 个</el-button>
              <el-button size="small" @click="loadInviteCodes">刷新</el-button>
            </div>
